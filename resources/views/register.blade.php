    ...
    <div class="py-6">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
              ...
              <div class="w-full p-8 lg:w-1/2">
                  <h2 class="text-2xl font-semibold text-gray-700 text-center">PostaLiked</h2>
                  ...
                  <div class="mt-4">
                    <form action="{{ route('registers') }}" method="post">
                      ...
                      <input name="name" class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="text">
                      @error('name')
                        <p class="bg-red-300 pl-2">{{ $message }}</p>
                      @enderror
                  </div>
                  <div class="mt-4">
                  ...
                  <div class="mt-4 flex items-center justify-between">
                      ...
                      <a href="/login" class="text-xs text-gray-500 uppercase">or sign in</a>
                      <span class="border-b w-1/5 md:w-1/4"></span>
                  </div>
              </div>
          </div>
